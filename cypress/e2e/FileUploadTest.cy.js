describe('File Upload Test', () => {
  ...
  it('0.3.1 should upload files SEMAFORO, Anexo 4 Anexo 1 y 3, Anexo 5 with delete', () => {
    cy.visit('/#/Home', { timeout: 10000 });
 ...
 it('0.3.1 should upload files SEMAFORO, Anexo 4 Anexo 1 y 3 and Anexo2', () => {
    cy.visit('/#/Home', { timeout: 10000 });
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//DEPRECATED TEST IN NEW VERSION
/*
  it('DEPRECATED should upload files SEMAFORO, Anexo 4 Anexo 1 y 3, Anexo 5 and Anexo2', () => {
    cy.visit('/#/Home', { timeout: 10000 });
...
*/
/*
  it('DEPRECATED should upload files SEMAFORO, Anexo 4 Anexo 1 y 3, Anexo 5 and delete', () => {
    cy.visit('/#/Home', { timeout: 10000 });
    ...
    // Verify the toast message
    //cy.verifyToastMessage('ErrorLa columna Coment. de la hoja Control de CURSOS del excel Semáforo tiene un valor SI, y no se ha adjuntado Anexo 5 o no tiene valores mostrables');
    ...
    // Verify the validation message in toast
    //cy.verifyToastMessage('La hoja del excel A-2024-FI-7103-O1-4 no existe en la archivo Anexo 4.');
